...
if [ -n "$EXTERNAL_DP" ]; then
  ...
  xrandr --output $EXTERNAL_HDMI --primary --scale 1x1 --mode 2560x1440 --$DIRECTION $INTERNAL
  echo "Setting up laptop monitor as secondary to 2560x1440 with 0.9 scaling (slightly largr font)."
  xrandr --output $INTERNAL --scale 0.9x0.9 --mode 2560x1440
else
